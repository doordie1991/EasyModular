...
namespace EasyModular
{
    ...
    public static class AssemblyHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static Assembly LoadByName(string assemblyName)
        {
            var url = $"{AppContext.BaseDirectory}{assemblyName}";
            try
            {
                return AssemblyLoadContext.Default.LoadFromAssemblyPath(url);
            }
            catch (Exception)
            {
                return null;
