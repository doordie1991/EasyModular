...
namespace Demo.Admin.Web
{
    ...
    public class  AuditInfoController : ModuleController
    {
        ...
        public  AuditInfoController(ILoginInfo loginInfo,IAuditInfoService AuditInfoService)
        {
            _service = AuditInfoService;
        }
        ...
        [HttpPost]
        [Description("更新")]
        public Task<IResultModel> Update(AuditInfoUpdateModel model)
        {
